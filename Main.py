...
# 1.首頁(APP)
from APP.Home import Weather, ParkingFee, OperationalStatus, RoadCondition,Plot
...
# 3.即時訊息推播(APP)
from APP.CMS import Main, Sidebar, SpeedEnforcement, ParkingLocation, PBS, Parking
app.include_router(Main.router)
