...
@router.get("/NearbyTrafficCondition/Car", summary="【Read】附近路況-汽車模式")
async def getNearbyTrafficConditionCar(latitude: str, longitude: str, token: HTTPAuthorizationCredentials = Depends(HTTPBearer())):
