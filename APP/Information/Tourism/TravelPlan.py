...
async def TravelPlan(latitude:str,longitude:str,DestinationLatitude:str,DestinationLongitude:str,StartTime:datetime,token: HTTPAuthorizationCredentials = Depends(HTTPBearer())):
    """
        1.公共運輸旅運規劃功能模組
